...
export const DIRECTIONS = {
  tr: {
    ...
    soundOn: 'Lyd på',
    voice: 'Stemme',
    focusBadge: (focus) => `Setningen øver på ${focus}. Klikk for flere setninger med det.`,
    backFromChest: (word) => `«${word}» er hentet fra kista for å øves igjen. Klikk for å gå til ordet.`,
    backFromHint: (word) => `«${word}» trengte hint sist. Klikk for å gå til ordet.`,
  ...
  nb: {
    ...
    soundOn: 'Sesi aç',
    voice: 'Ses',
    focusBadge: (focus) => `Bu cümle ${focus} konusunu çalıştırıyor. Aynı konuda daha fazla cümle için tıkla.`,
    backFromChest: (word) => `«${word}» yeniden çalışmak için sandıktan geldi. Kelimeye gitmek için tıkla.`,
    backFromHint: (word) => `«${word}» geçen sefer ipucu istedi. Kelimeye gitmek için tıkla.`,
