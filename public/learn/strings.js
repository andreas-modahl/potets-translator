...
export const DIRECTIONS = {
  tr: {
    ...
    hint: 'Hint',
    withHint: 'Løst med hint:',
    hintCollect: 'Prøv uten hint neste gang for å samle.',
    hintPractice: 'Allerede i kista. Øv uten hint for mer mestring.',
  ...
  nb: {
    ...
    hint: 'İpucu',
    withHint: 'İpucuyla tamamlanan:',
    hintCollect: 'Sandığa eklemek için bir dahaki sefere ipucusuz dene.',
    hintPractice: 'Zaten sandıkta. Ustalığını artırmak için ipucusuz çalış.',
    specials: ['æ', 'ø', 'å'],
